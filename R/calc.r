calc <- function(allelefrequency,sample.sizes,x){
    ...
    allelefrequency$number <- as.numeric(as.vector(allelefrequency$number))
    allelefrequency$proportion <- as.numeric(as.vector(allelefrequency$proportion))
    
    sample.sizes <- sample.sizes
    sample.sizes$sample.size <- as.numeric(as.vector(sample.sizes$sample.size))
